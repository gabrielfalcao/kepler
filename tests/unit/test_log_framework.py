...
from kepler.framework.log import (
    ColorFormatter,
...
@patch('kepler.framework.log.settings')
@patch('kepler.framework.log.logging')
...
@patch('kepler.framework.log.settings')
@patch('kepler.framework.log.logging')
@patch('kepler.framework.log.ColorFormatter')
...
@patch('kepler.framework.log.logging')
@patch('kepler.framework.log.datetime')

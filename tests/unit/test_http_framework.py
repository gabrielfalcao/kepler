...
from kepler.framework.http import (
    absolute_url,
    ssl_absolute_url,
...
@patch('kepler.framework.http.settings')
...
@patch('kepler.framework.http.request')
...
@patch('kepler.framework.http.set_cors_into_headers')
@patch('kepler.framework.http.json_response')
...
@patch('kepler.framework.http.current_app')
@patch('kepler.framework.http.set_cors_into_headers')
...
@patch('kepler.framework.http.Response')
@patch('kepler.framework.http.json')

...
from kepler.framework.handy.functions import (
    slugify,
    empty,
    now,
    geo_data_for_ip,
...
@patch('kepler.framework.handy.functions.datetime')
...
@patch('kepler.framework.handy.functions.request')
...
@patch('kepler.framework.handy.functions.PyGEOIP')

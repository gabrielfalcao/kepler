...
from kepler.framework.core import Application, ErrorHandlers


@patch('kepler.framework.core.Flask')
def test_application_has_flask_app(Flask):
    ...
    Flask.assert_called_once_with('kepler.framework.core')
...
@patch('kepler.framework.core.ErrorHandlers')
@patch('kepler.framework.core.Flask')
...
@patch('kepler.framework.core.RedisSessionInterface')
@patch('kepler.framework.core.Flask')
...
@patch('kepler.framework.core.AssetsManager')
@patch('kepler.framework.core.Flask')
...
@patch('kepler.framework.core.Manager')
@patch('kepler.framework.core.Flask')
...
@patch('kepler.framework.core.log')
@patch('kepler.framework.core.Flask')
...
def test_setup_logging(Flask, log):
    ...
    log.get_logger.assert_has_calls([
        call('kepler'),
        call('kepler.api.models'),
        call('kepler.api.resources'),
        call('kepler.framework.http'),
        call('kepler.framework.db'),
    ])

    # And setup_handler_for_logger should have been called for each handler
    app.setup_handler_for_logger.assert_has_calls([
        call('handler for [kepler]', output, logging.WARNING),
        call('handler for [kepler.api.models]', output, logging.WARNING),
        call('handler for [kepler.api.resources]', output, logging.WARNING),
        call('handler for [kepler.framework.http]', output, logging.WARNING),
        call('handler for [kepler.framework.db]', output, logging.WARNING),

   ])


@patch('kepler.framework.core.os')
@patch('kepler.framework.core.RedisSessionInterface')
@patch('kepler.framework.core.Flask')
...
@patch('kepler.framework.core.render_template')

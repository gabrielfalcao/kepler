...
from kepler.framework.formats.json import json_converter, loads, dumps
...
@patch('kepler.framework.formats.json.json')
...
@patch('kepler.framework.formats.json.json')
@patch('kepler.framework.formats.json.json_converter')

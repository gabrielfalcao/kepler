...
os.environ.setdefault('DOMAIN', 'kepler.propellr.com')
os.environ.setdefault('HOST', 'kepler.propellr.com')
...
#STATIC_BASE_URL = '//static.kepler.s3-website-us-east-1.amazonaws.com/s/'
STATIC_BASE_URL = '/static/'

# Identifying environment
LOCAL = env.get('KEPLER_LOCAL_MODE') or (PORT is LOCAL_PORT)
...
LOGGER_NAMES = [
    'kepler',
    'kepler.api.models',
    'kepler.api.resources',
    'kepler.framework.http',
    'kepler.framework.db',
    'kepler.web.models',
    'kepler.web.controllers',
]
...
kepler_path = abspath(join(__file__, '..', '..'))

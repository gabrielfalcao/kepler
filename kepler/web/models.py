...
from kepler.framework.db import Model, metadata
from kepler.framework.log import get_logger

from kepler.framework.handy.functions import now


logger = get_logger('kepler.web.models')

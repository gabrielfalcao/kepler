...
class Application(object):
    ...
    Welcome to the kepler Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the kepler application: it knows
    ...
    def __init__(self, settings_path='kepler.settings', *args, **kwargs):
        self.assets = None
    ...
    def enable_commands(self, commands):
        ...
        """
        # Ensure local mode
        os.environ.setdefault("KEPLER_LOCAL_MODE", "true")
    ...
    def from_env(CreateApplication,
                 environment_variable_name='KEPLER_SETTINGS_MODULE',
                 fallback_module_name='kepler.settings',
                 *flask_args,
                 **flask_kwargs
        ):
